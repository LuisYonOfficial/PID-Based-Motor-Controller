...
(library Library_1
	...
	(symbolDef "TLMO1000-GS08" (originalName "TLMO1000-GS08")
	...
	(compDef "TLMO1000-GS08" (originalName "TLMO1000-GS08") (compHeader (numPins 2) (numParts 1) (refDesPrefix LED)
		)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "TLMO1000-GS08"))
		...
		(attr "Mouser Part Number" "78-TLMO1000")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Vishay-Semiconductors/TLMO1000-GS08?qs=oNDV51lhjEPQ5ghR1MAWhw%3D%3D")
		(attr "Manufacturer_Name" "Vishay")
		(attr "Manufacturer_Part_Number" "TLMO1000-GS08")
		(attr "Description" "LED Uni-Color Orange 610nm Vishay TLMO1000-GS08 Orange LED, 605 nm, 1608 (0603), Rectangle Lens SMD Package")
		(attr "<Hyperlink>" "https://componentsearchengine.com/Datasheets/2/TLMO1000-GS08.pdf")
		(attr "<Component Height>" "0.65")
		(attr "<STEP Filename>" "TLMO1000-GS08.stp")
		(attr "<STEP Offsets>" "X=0;Y=0.06;Z=-0.03")
